...
public class MtlAmbientColorImpl extends ASTWrapperPsiElement implements MtlAmbientColor {

  public MtlAmbientColorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitAmbientColor(this);
  }
