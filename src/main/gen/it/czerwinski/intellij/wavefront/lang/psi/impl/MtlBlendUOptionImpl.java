...
public class MtlBlendUOptionImpl extends MtlFlagValueElementImpl implements MtlBlendUOption {

  public MtlBlendUOptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitBlendUOption(this);
  }
