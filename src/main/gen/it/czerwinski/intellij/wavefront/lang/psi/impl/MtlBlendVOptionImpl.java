...
public class MtlBlendVOptionImpl extends MtlFlagValueElementImpl implements MtlBlendVOption {

  public MtlBlendVOptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitBlendVOption(this);
  }
