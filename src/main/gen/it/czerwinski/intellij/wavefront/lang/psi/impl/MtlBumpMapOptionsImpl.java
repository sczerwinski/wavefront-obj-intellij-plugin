...
public class MtlBumpMapOptionsImpl extends ASTWrapperPsiElement implements MtlBumpMapOptions {

  public MtlBumpMapOptionsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitBumpMapOptions(this);
  }
