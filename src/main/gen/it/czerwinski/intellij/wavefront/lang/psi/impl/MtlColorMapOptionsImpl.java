...
public class MtlColorMapOptionsImpl extends ASTWrapperPsiElement implements MtlColorMapOptions {

  public MtlColorMapOptionsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitColorMapOptions(this);
  }
