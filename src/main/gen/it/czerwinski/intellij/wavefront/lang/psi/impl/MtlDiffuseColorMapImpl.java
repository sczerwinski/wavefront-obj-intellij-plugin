...
public class MtlDiffuseColorMapImpl extends MtlTextureElementImpl implements MtlDiffuseColorMap {

  public MtlDiffuseColorMapImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitDiffuseColorMap(this);
  }
