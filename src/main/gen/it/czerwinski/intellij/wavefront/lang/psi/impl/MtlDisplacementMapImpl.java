...
public class MtlDisplacementMapImpl extends MtlTextureElementImpl implements MtlDisplacementMap {

  public MtlDisplacementMapImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitDisplacementMap(this);
  }
