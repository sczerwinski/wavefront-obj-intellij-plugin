...
public class MtlDissolveImpl extends MtlFloatValueElementImpl implements MtlDissolve {

  public MtlDissolveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitDissolve(this);
  }
