...
public class MtlMaterialIdentifierImpl extends MtlMaterialIdentifierElementImpl implements MtlMaterialIdentifier {

  public MtlMaterialIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitMaterialIdentifier(this);
  }
