...
public class MtlOffsetOptionImpl extends MtlFloatVectorValueElementImpl implements MtlOffsetOption {

  public MtlOffsetOptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitOffsetOption(this);
  }
