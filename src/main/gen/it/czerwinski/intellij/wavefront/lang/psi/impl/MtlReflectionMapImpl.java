...
public class MtlReflectionMapImpl extends MtlTextureElementImpl implements MtlReflectionMap {
  ...
  @Override
  @NotNull
  public List<MtlColorCorrectionOption> getColorCorrectionOptionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MtlColorCorrectionOption.class);
  }
