...
public class MtlReflectionTypeOptionImpl extends MtlReflectionTypeValueElementImpl implements MtlReflectionTypeOption {

  public MtlReflectionTypeOptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitReflectionTypeOption(this);
  }
