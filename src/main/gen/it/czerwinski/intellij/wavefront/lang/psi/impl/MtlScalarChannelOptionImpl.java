...
public class MtlScalarChannelOptionImpl extends MtlScalarChannelValueElementImpl implements MtlScalarChannelOption {

  public MtlScalarChannelOptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitScalarChannelOption(this);
  }
