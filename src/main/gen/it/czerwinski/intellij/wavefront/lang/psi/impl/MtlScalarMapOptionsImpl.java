...
public class MtlScalarMapOptionsImpl extends ASTWrapperPsiElement implements MtlScalarMapOptions {

  public MtlScalarMapOptionsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitScalarMapOptions(this);
  }
