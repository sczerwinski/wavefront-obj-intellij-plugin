...
public class MtlSharpnessImpl extends MtlFloatValueElementImpl implements MtlSharpness {

  public MtlSharpnessImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitSharpness(this);
  }
