...
public class MtlSpecularExponentImpl extends MtlFloatValueElementImpl implements MtlSpecularExponent {

  public MtlSpecularExponentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitSpecularExponent(this);
  }
