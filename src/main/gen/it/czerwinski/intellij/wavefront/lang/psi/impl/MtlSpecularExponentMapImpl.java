...
public class MtlSpecularExponentMapImpl extends MtlTextureElementImpl implements MtlSpecularExponentMap {

  public MtlSpecularExponentMapImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitSpecularExponentMap(this);
  }
