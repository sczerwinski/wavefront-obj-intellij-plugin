...
public class MtlTransmissionFilterImpl extends ASTWrapperPsiElement implements MtlTransmissionFilter {

  public MtlTransmissionFilterImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitTransmissionFilter(this);
  }
