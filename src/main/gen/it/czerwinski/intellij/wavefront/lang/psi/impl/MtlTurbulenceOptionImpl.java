...
public class MtlTurbulenceOptionImpl extends MtlFloatVectorValueElementImpl implements MtlTurbulenceOption {

  public MtlTurbulenceOptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitTurbulenceOption(this);
  }
