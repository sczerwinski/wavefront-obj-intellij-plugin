...
public class MtlValueModifierOptionImpl extends MtlFloatVectorValueElementImpl implements MtlValueModifierOption {

  public MtlValueModifierOptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MtlVisitor visitor) {
    visitor.visitValueModifierOption(this);
  }
