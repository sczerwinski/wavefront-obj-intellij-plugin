...
public class ObjVertexIndexImpl extends ASTWrapperPsiElement implements ObjVertexIndex {

  public ObjVertexIndexImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ObjVisitor visitor) {
    visitor.visitVertexIndex(this);
  }
