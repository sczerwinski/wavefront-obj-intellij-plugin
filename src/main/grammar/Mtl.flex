...
<WAITING_MATERIAL_NAME> {MATERIAL_NAME} { yybegin(YYINITIAL); return MtlTypes.MATERIAL_NAME; }
...
<WAITING_ILLUMINATION_VALUE> {ILLUMINATION_VALUE} { yybegin(YYINITIAL); return MtlTypes.ILLUMINATION_VALUE; }
...
<WAITING_OPTION_OR_TEXTURE> {TEXTURE_FILE_NAME} { yybegin(YYINITIAL); return MtlTypes.TEXTURE_FILE; }
...
<WAITING_FLOAT_OR_OPTION_OR_TEXTURE> {TEXTURE_FILE_NAME} { yybegin(YYINITIAL); return MtlTypes.TEXTURE_FILE; }
