...
<YYINITIAL> [^\ \t\r\n\f]+ { yybegin(INVALID); return MtlUnknownTypes.UNKNOWN_KEYWORD; }
...
<WAITING_FLAG> [^\ \t\r\n\f]+ { yybegin(WAITING_OPTION_OR_TEXTURE); return MtlUnknownTypes.UNKNOWN_FLAG; }
...
<WAITING_ILLUMINATION_VALUE> [^\ \t\r\n\f]+ { yybegin(WAITING_OPTION_OR_TEXTURE); return MtlUnknownTypes.UNKNOWN_ILLUMINATION_VALUE; }
...
<WAITING_SCALAR_CHANNEL> [^\ \t\r\n\f]+ { yybegin(WAITING_OPTION_OR_TEXTURE); return MtlUnknownTypes.UNKNOWN_SCALAR_CHANNEL; }
...
<WAITING_REFLECTION_TYPE_OPTION_NAME> [^\ \t\r\n\f]+ { yybegin(WAITING_REFLECTION_TYPE); return MtlUnknownTypes.UNKNOWN_REFLECTION_TYPE_OPTION; }
...
<WAITING_REFLECTION_TYPE> [^\ \t\r\n\f]+ { yybegin(WAITING_REFLECTION_TYPE); return MtlUnknownTypes.UNKNOWN_REFLECTION_TYPE; }
...
<WAITING_OPTION_OR_TEXTURE> {OPTION_START} { yybegin(WAITING_OPTION_OR_TEXTURE); return MtlUnknownTypes.UNKNOWN_OPTION; }
...
<WAITING_FLOAT_OR_OPTION_OR_TEXTURE> {OPTION_START} { yybegin(WAITING_OPTION_OR_TEXTURE); return MtlUnknownTypes.UNKNOWN_OPTION; }
