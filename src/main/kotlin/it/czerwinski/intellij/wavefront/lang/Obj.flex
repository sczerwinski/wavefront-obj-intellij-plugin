...
<YYINITIAL> {MATERIAL_FILE_REF_KEYWORD} { yybegin(WAITING_REFERENCE); return ObjTypes.MATERIAL_FILE_REF_KEYWORD; }
<YYINITIAL> {MATERIAL_REFERENCE_KEYWORD} { yybegin(WAITING_REFERENCE); return ObjTypes.MATERIAL_REFERENCE_KEYWORD; }
...
<WAITING_REFERENCE> {WHITE_SPACE} { yybegin(WAITING_REFERENCE); return TokenType.WHITE_SPACE; }
<WAITING_REFERENCE> {REFERENCE} { yybegin(YYINITIAL); return ObjTypes.REFERENCE; }
