...
class ObjDuplicatedMtlFileReferenceInspection : LocalInspectionTool() {
    ...
    private class MyPsiElementVisitor(
        ...
        private fun visitMaterialFileReference(element: ObjMaterialFileReference) {
            if (element.mtlFile != null && element.isDuplicated) {
                holder.registerProblem(
                    element,
                    WavefrontObjBundle.message(key = "fileTypes.obj.inspection.duplicateMtlReference.description"),
