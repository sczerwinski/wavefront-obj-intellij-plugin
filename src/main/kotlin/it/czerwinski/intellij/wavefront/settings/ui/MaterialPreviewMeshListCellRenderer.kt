    ...
    SimpleListCellRenderer.create("") { value ->
        when (value) {
            ...
            MaterialPreviewMesh.CYLINDER ->
                WavefrontObjBundle.message("settings.editor.fileTypes.mtl.material.previewMesh.cylinder")
            MaterialPreviewMesh.SPHERE ->
                WavefrontObjBundle.message("settings.editor.fileTypes.mtl.material.previewMesh.sphere")
            else ->
                null
        }
    }
